...
static MIGRATIONS: &[M] = &[
    ...
    M::up("ALTER TABLE transcription_history ADD COLUMN post_process_prompt_name TEXT;"),
];
...
impl HistoryManager {
    ...
    fn map_history_entry(row: &rusqlite::Row<'_>) -> rusqlite::Result<HistoryEntry> {
        Ok(HistoryEntry {
            ...
            post_process_prompt_name: row.get("post_process_prompt_name")?,
    ...
    pub fn save_entry(
        ...
        post_process_prompt_name: Option<String>,
    ) -> Result<HistoryEntry> {
    ...
    pub fn update_transcription(
        ...
        let entry = conn
            .query_row(
                "SELECT id, file_name, timestamp, saved, title, transcription_text, post_processed_text, post_process_prompt, post_process_prompt_name, post_process_requested
